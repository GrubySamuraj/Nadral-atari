...
class Bullet {
    ...
    private width = 20;
    private height = 5;
    private WhiteList: string[] = ["#fa84d1", "#875e00", "#5f5c61", "#00546d", "#583d00", "#361c2d", "#463100", "#676469", "#8a6000", "#00181f", "#b66098", "#604300", "#0091b6", "#6e3a5c", "#002733", "#002731", "#005b72", "#000c10", "#007795", "#000d17", "#624400", "#0085a6", "#806066", "#007f7f", "#57ab3b", "#000000", "#901829", "#26060b", "#320924", "#8c1a65", "#081c51", "#123eb2", "#001936", "#008300", "#00489d", "#005d00", "#003900", "#627500", "#005274", "#5134ae", "#5a4300", "#adadad", "#aeaeae", "#0000ff", "#00ffff", "#FFC0CB", "#7f6065", "#00007f", "#000080", "#806065", "#008080"];
    private LampColor: string[] = ["#ffffff"];
    private npcColor: string[] = ["#676469", "#673674", "#ab5a8f", "#4e2941", "#006ec5", "#bd64d6", "#00799d", "#fa84d1", "#0093b8", "#8f6400", "#241900", "#00bcce", "#753e85", "#806066"];
